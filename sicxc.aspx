...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="TextBox1" runat="server" Text="Bernard Lagat"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="Submit" />
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:SICXCConnectionString %>' SelectCommand="select 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="TextBox1" PropertyName="Text" Name="Name" Type="String" DefaultValue="Bernard Lagat"></asp:ControlParameter>
            </SelectParameters>
        </asp:SqlDataSource>
